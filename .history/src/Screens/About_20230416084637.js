...
in the field of sustainable technologies.</li>
    ...
    <div className='bottom'>
        <div><a href="#" style={{display: 'inline-block'}} rel='noreferrer'><FaFacebook></FaFacebook></a></div>
        <div><a href="#" style={{display: 'inline-block'}} rel='noreferrer'><FaInstagram/></a></div>
        <div><a href="#" style={{display: 'inline-block'}} rel='noreferrer'><FaTwitter></FaTwitter></a></div>
        <div><a href="#" style={{display: 'inline-block'}} rel='noreferrer'><FaLinkedin></FaLinkedin></a></div>
        <div><a href="#" style={{display: 'inline-block'}} rel='noreferrer'><FaMailBulk></FaMailBulk></a></div>
    </div>
    </div>
    </div>
  )
