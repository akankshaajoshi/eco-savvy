...
in the field of sustainable technologies.</li>
    ...
    <div class="row">
        <div class="col"><a href="#"><FaFacebook></FaFacebook></a></div>
        <div class="col"><a href="#"><FaInstagram/></a></div>
        <div class="col"><a href="#"><FaTwitter></FaTwitter></a></div>
        <div class="col"><a href="#"><FaLinkedin></FaLinkedin></a></div>
        <div class="col"><a href="#"><FaMailBulk></FaMailBulk></a></div>
    </div>
    </>
  )
}
