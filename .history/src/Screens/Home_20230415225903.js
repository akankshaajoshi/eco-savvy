            ...
            <div id='blur'>
                ...
                <div id='resorce-section'>
                    <div id='res-1' className='resource'>
                        ...
                        <img src='src\Resources\solar energy.jpg' className='im' />
                    </div>
                    <div id='res-2' className='resource'>
                        ...
                        <img src='src\Resources\hydro energy.jpg' className='im'/>
                    </div>
                    <div id='res-3' className='resource'>
                        ...
                        <img src='src\Resources\wind power.jpg' className='im' />
                    </div>
                </div>
